...
<body>
    ...
    <div id="parent" class="container my-5 row-1">
        <h2 class="text-center">Результаты:</h2>

        <div id="results" class="bg-light rounded col p-3 m-3">

            <h4 id="post_title" class="text-center">(Имя поста)</h4>
        ...
        <div class="bg-light rounded col p-3 m-3">
            <h4 class="text-center">(Имя поста)</h4>
            <h5>Комментарии:</h5>
            <div>
                <ul>
                    <li>
